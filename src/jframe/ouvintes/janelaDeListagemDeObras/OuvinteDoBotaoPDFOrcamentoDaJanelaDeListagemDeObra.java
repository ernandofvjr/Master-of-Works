...
public class OuvinteDoBotaoPDFOrcamentoDaJanelaDeListagemDeObra implements ActionListener{
	
	private JanelaDeListagemDeObras janela;
	
	public OuvinteDoBotaoPDFOrcamentoDaJanelaDeListagemDeObra(JanelaDeListagemDeObras janela) {
		this.janela = janela;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			pe.salvaExcecucaoOrcamentariaDeObra(gerente.buscarObra(nomeDaObra));
