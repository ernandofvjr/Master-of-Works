...
public class OuvinteDoBotaoCalendarioInicioAtividade implements PropertyChangeListener {
	
private JanelaCadastroDeAtividade janela;
	
	public OuvinteDoBotaoCalendarioInicioAtividade(JanelaCadastroDeAtividade janela){
		this.janela = janela;
	}
